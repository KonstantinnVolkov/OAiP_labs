...
begin
  ...
  Graph_Drawing(Integral_1, -0.84, 25, 100000, 100, IGraph);
end;
...
begin
  IGraph.Canvas.Pen.Color := clBlack;
  IGraph.Canvas.Rectangle(0,0,IGraph.Width,IGraph.Height);
  Graph_Drawing(Integral_2, -25, 25, 100000, 100, IGraph);
end;
...
begin
  IGraph.Canvas.Pen.Color := clBlack;
  IGraph.Canvas.Rectangle(0,0,IGraph.Width,IGraph.Height);
  Graph_Drawing(Integral_3, 1.00001, 25, 100000, 100, IGraph);
  Graph_Drawing(Integral_3, -25, -1.00001, 100000, 100, IGraph);
end;
...
begin
  IGraph.Canvas.Pen.Color := clBlack;
  IGraph.Canvas.Rectangle(0,0,IGraph.Width,IGraph.Height);
  Graph_Drawing(Integral_4, -25, 25, 100000, 100, IGraph);
end;
